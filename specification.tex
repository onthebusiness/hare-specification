...
\newcommand{\code}[1]{\mbox{\under{\small\texttt{#1}}}}
...
\newcommand{\specsubsubitem}{
	...
	\thechapter.\thespecctr.\thespecsubctr.\Alph{specsubsubctr}:
}
...
\setcounter{subsections}{\value{specsubctr}}
\stepcounter{specsubctr}
\setcounter{specsubsubctr}{0}
\subsection{#1}
\label{subsec:#1}
...
\newcommand{\subitemref}[2]{\ref{sec:#1}.#2}
