...
\nonterminaldef{argument-list} \\
	\nonterminal{complex-expression} \optional{\terminal{,}} \\
	\nonterminal{complex-expression} \terminal{...} \optional{\terminal{,}} \\
...
\nonterminaldef{binding} \\
	\nonterminal{name} \terminal{=} \nonterminal{complex-expression} \\
	\nonterminal{name} \terminal{:} \nonterminal{type} \terminal{=} \nonterminal{complex-expression} \\
	\nonterminal{binding-names} \terminal{=} \nonterminal{complex-expression} \\
	\nonterminal{binding-names} \terminal{:} \nonterminal{type} \terminal{=} \nonterminal{complex-expression} \\
...
\nonterminal{complex-expression} shall be of a tuple type with a number of
values equal to the number of times \nonterminal{name} is given. The
implementation shall create separate bindings for each name, of the type of the
corresponding tuple value, and initialize them to that value from the tuple.
