...
\nonterminaldef{measurement-expression} \\
	...
	\nonterminal{capacity-expression} \\
...
\nonterminaldef{capacity-expression} \\
	\terminal{cap} \terminal{(} \nonterminal{expression} \terminal{)} \\
...
\specsubsubitem
The \terminal{cap} expression shall compute the \code{capacity} field of a slice
object, or the \code{capacity} field of a \terminal{str}, referred to by
\nonterminal{expression}.

\specsubsubitem
The object used for a \nonterminal{capacity-expression} shall be the slice or
\terminal{str} object the \nonterminal{expression} refers to, selecting the
...
\specsubsubitem
The object used for a \nonterminal{length-expression} shall be the array, slice,
or \terminal{str} object the \nonterminal{expression} refers to, selecting that
object indirectly via any number of non-nullable pointer types if appropriate.
