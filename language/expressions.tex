...
\specsubitem
A \nonterminal{string-char} shall be represented in the same manner as a
\nonterminal{rune}.
...
\specsubsubitem
If the \terminal{...} form is used, the result's array type shall be expandible.
...
\nonterminaldef{argument-list} \\
	\nonterminal{argument} \optional{\terminal{,}} \\
	\nonterminal{argument} \terminal{,} \nonterminal{argument-list} \\

\nonterminaldef{argument} \\
...
\nonterminal{argument-list} shall provide zero or more arguments for the final
parameter, all of which must be assignable to the type of the variadic
parameter.

\specsubsubitem
If an argument uses the optional \terminal{...} terminal, it must occupy the
position of a variadic parameter and have a slice or array type. Only the final
argument shall use the \terminal{...} terminal, and if present, no other
variadic arguments shall be provied. The implementation shall interpret this
value as the list of variadic arguments.
