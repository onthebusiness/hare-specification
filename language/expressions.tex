...
\nonterminaldef{struct-literal} \\
	...
	\nonterminal{identifier} \terminal{\{} \nonterminal{field-values} \optional{\nonterminal{struct-zeroizer}} \terminal{\}} \\

\nonterminaldef{struct-zeroizer} \\
	\terminal{0} \terminal{...} \\

\nonterminaldef{field-values} \\
	\nonterminal{field-value} \optional{\terminal{,}} \\
	\nonterminal{field-value} \terminal{,} \nonterminal{field-values} \\
...
\specsubsubitem
If the \nonterminal{struct-zeroizer} is not present, \nonterminal{field-values}
shall be \textit{exhaustive}, and include every field of the result type
exactly once. Otherwise, a diagnostic message shall be printed and the
translation phase shall abort.

\specsubsubitem
If the \nonterminal{struct-zeroizer} is present, any fields of the result type
which are not included in \nonterminal{field-values} shall be initialized to
