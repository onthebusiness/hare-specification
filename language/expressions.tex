...
\specsubsubitem
The \terminal{null} keyword represents the value of the \terminal{null} type.
...
\item The type of the next variadic parameter is assignable to the type hint
	...
	is a pointer type, or either the type of the next variadic parameter or
	the type hint has a size of zero
\end{enumerate}
...
type, shall yield the same pointer. Likewise, casting \terminal{null} to a
