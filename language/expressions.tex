...
\specsubsubitem
If the third form of \nonterminal{field-values} is not given,
\nonterminal{field-values} shall be \textit{exhaustive}, and include every
field of the result type exactly once. Otherwise, a diagnostic message shall be
printed and the translation phase shall abort.

\specsubsubitem
If the third form of \nonterminal{field-values} is given, any fields of the
result type which are not included in \nonterminal{field-values} shall be
