...
\specsubsubitem
The result type of the first term shall not be of a \terminal{const} type. If
any indirection is used to access the value (e.g. via
\nonterminal{field-access-expression}), the object shall not have any logical
anscestors of a \terminal{const} type.
