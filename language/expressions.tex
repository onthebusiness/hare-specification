...
other respects the semantics shall be the same as the first form. The order of
side-effects between the initializer and capacity is undefined.
...
\nonterminal{compound-expression}s scope.
...
\nonterminal{compound-expression} to terminate in a specific way. A control
statement is a terminating expression and its result type is \terminal{void}.
...
expression is provided, it shall be used as the result value for the
