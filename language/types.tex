...
\specsubsection{Meta-types}

\specsubsubitem
The \terminal{type} type is a meta-type, which represents information about
another type. Its size and alignment shall be equivalent to a pointer type. It
shall be represented as a pointer to a type information structure as described
by \secref{Reflection}.
