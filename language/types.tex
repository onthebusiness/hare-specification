...
\nonterminal{i64}, \nonterminal{u8}, \nonterminal{u16}, \nonterminal{u32}, and
\nonterminal{u64} are specified by the numeric suffix. Of those, types prefixed
with \terminal{u} are unsigned, and those prefixed with \terminal{i} are signed.

\specsubsubitem
The width of \nonterminal{int} and \nonterminal{uint} are
implementation-defined. \nonterminal{int} shall be signed, and
\nonterminal{uint} shall be unsigned. Both types shall have the same width,
which, in bits, shall be a power of two no smaller than 32.

\specsubsubitem
The width of \nonterminal{size} is implementation-defined. It shall be unsigned
and shall be able to represent the maximum length of an array type. The width in
bits shall be a power of two.

\specsubsubitem
The width of \nonterminal{uintptr} is implementation-defined. It shall be able
to represent the value of any \nonterminal{pointer-type} (including
...
\specsubsubitem
An \terminal{iconst} shall have a maximum and minimum value associated with it,
...
default type for \terminal{rconst} shall be \terminal{rune}. The default type
for \terminal{iconst} shall be \terminal{int} if the maximum and minimum values
are representable as \terminal{int}, otherwise \terminal{i64} if the maximum and
