...
plus the size of the \terminal{size} type, plus any padding added per
...
be \terminal{void}), and zero or more parameters.
...
\terminal{const} in the type description. Function types shall not be cast to
