...
capacity are measured in octets, rather than codepoints. The length and
capacity shall include an additional octet for a NUL terminator, which shall be
placed at the end of the UTF-8 sequence.
