...
\specsubsubitem
The default value of a slice type shall set its capacity and length fields to
zero, and the data field set to null.
...
\nonterminaldef{prototype} \\
	\nonterminal{type} \\
	\terminal{(} \nonterminal{parameter-list} \optional{\terminal{,}} \terminal{)} \nonterminal{type} \\

\nonterminaldef{parameter-list} \\
	\nonterminal{parameter-binding} \\
