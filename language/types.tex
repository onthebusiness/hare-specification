...
This specification details under what circumstances two types are distinct to
...
constituent types. This value shall be stored at the \terminal{size} field and
...
\specsubsubitem
A tagged union type shall be equivalent if they share the same set of secondary
types, without regard to order, and considering the secondary types of nested
tagged unions as members of the set of their parent's secondary types.
...
type, for the purpose of determining equivilancy.
