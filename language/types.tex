...
which are collected by a struct or union, and optionally assigns a
...
field's type and which is greater than the offset of the previous field. The
implementation shall add \textit{padding} to meet the alignment requirements of
struct fields. For a union type, the offset of all
members is zero.
...
\specsubsubitem
A struct or union type shall be equivqalent to another struct or union type if
