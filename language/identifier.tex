...
\nonterminal{for-loop}, or a \nonterminal{compound-expression}. After an
...
\specsubitem
Scopes which encompass a \nonterminal{for-loop} or
\nonterminal{compound-expression} may be \textit{labelled}. A labelled scope has
a \nonterminal{name} associated with it; the name need not be unique.
