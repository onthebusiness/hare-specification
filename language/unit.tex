...
a flexible constant result type.}
...
\nonterminaldef{imports}\\
	\nonterminal{use-statement} \optional{\nonterminal{imports}}\\
...
\specsubitem
The second form of the \nonterminal{use-statement} shall cause identifiers of
the form "x::y" to be made available, where x is the provided
\nonterminal{name}, and y is each of the exported members of the target module.
