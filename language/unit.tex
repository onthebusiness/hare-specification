...
\specsubsubitem
The interpretation of the \terminal{@threadlocal} form of
\nonterminal{decl-attr} is implementation-defined.

\informative{The purpose of this directive is to store a separate copy of a
global for each thread, similar to \_Thread\_local in C.}
